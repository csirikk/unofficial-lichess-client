...
function App() {
  return (
    <div className="min-h-screen bg-l-bg-1 dark:bg-d-bg-1 text-l-text-1 dark:text-d-text-1">
      {/* Hero Section */}
      <header className="relative overflow-hidden bg-linear-to-br from-l-bg-1 via-l-bg-2 to-l-bg-3 dark:from-d-bg-1 dark:via-d-bg-2 dark:to-d-bg-3">
        <div className="container mx-auto px-4 md:px-8">
          <nav className="flex justify-between items-center py-6">
            <div className="text-xl font-bold text-accent-1">
              React Template
            </div>
            <ThemeToggle />
          </nav>
...
<span className="text-accent-success">Success</span>`}
        ...
        {/* Getting Started */}
        <section id="quick-start" className="py-20 bg-l-bg-1 dark:bg-d-bg-1">
          <div className="container mx-auto px-4 md:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-l-text-1 dark:text-d-text-1">
                Quick Start Guide
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center">
            <div className="mb-6">
              ...
              <p className="text-l-text-2 dark:text-d-text-2">
                Start your next project with this comprehensive React template
              </p>
            </div>
            ...
            <div className="text-l-text-3 dark:text-d-text-3">
              <p>React 19 + TypeScript + Vite + Tailwind CSS v4</p>
              <p className="mt-1">
                Built with 💙 by{' '}
                <a
...
function CodeBlock({ title, code }: CodeBlockProps) {
  return (
    <div className="bg-l-bg-3 dark:bg-d-bg-3 rounded-lg overflow-hidden border border-border-l dark:border-border-d">
      <div className="bg-l-bg-2 dark:bg-d-bg-2 px-4 py-2 border-b border-border-l dark:border-border-d">
  ...
  return (
    <div className="flex gap-4">
      ...
      <div className="flex-1">
        ...
        <code className="block bg-l-bg-3 dark:bg-d-bg-3 text-accent-1 p-3 rounded-lg text-sm overflow-x-auto">
          {code}
        </code>
      </div>
    </div>
...
function ScriptCommand({ command, description }: ScriptCommandProps) {
  return (
    <div className="flex justify-between items-center py-2">
      <code className="bg-l-bg-3 dark:bg-d-bg-3 text-accent-1 px-3 py-1 rounded font-mono text-sm">
        {command}
      </code>
